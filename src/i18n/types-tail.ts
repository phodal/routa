export interface TailTranslationDictionarySections {
  ...
  debug: {
    ...
    dllViewerTitle: string;
    dllViewerDescription: string;
    dllViewerSelectFile: string;
    dllViewerStatus: string;
    dllViewerStatusIdle: string;
    dllViewerStatusParsing: string;
    dllViewerStatusReady: string;
    dllViewerStatusError: string;
    dllViewerError: string;
    dllViewerNoResult: string;
    dllViewerSummary: string;
    dllViewerFile: string;
    dllViewerFormat: string;
    dllViewerMachine: string;
    dllViewerSubsystem: string;
    dllViewerEntryPoint: string;
    dllViewerImageBase: string;
    dllViewerTimestamp: string;
    dllViewerPeOffset: string;
    dllViewerSectionAlignment: string;
    dllViewerFileAlignment: string;
    dllViewerSizeOfImage: string;
    dllViewerChecksum: string;
    dllViewerCharacteristics: string;
    dllViewerExports: string;
    dllViewerImports: string;
    dllViewerSections: string;
    dllViewerDataDirectories: string;
    dllViewerWarnings: string;
    dllViewerRawJson: string;
    dllViewerDllName: string;
    dllViewerOrdinalBase: string;
    dllViewerFunctionCount: string;
    dllViewerNoExports: string;
    dllViewerNoImports: string;
    dllViewerShowingFirstExports: string;
    dllViewerShowingFirstImports: string;
    dllViewerFunctions: string;
    dllViewerName: string;
    dllViewerVirtualAddress: string;
    dllViewerVirtualSize: string;
    dllViewerRawPointer: string;
    dllViewerRawSize: string;
    dllViewerRva: string;
    dllViewerSize: string;
    dllViewerOrdinal: string;
    dllViewerForwardedTo: string;
  };
