...
Sessions starts from one recoverable execution thread. The system can still bring in
specialists when the task needs them, but the run begins as one session, not as a fixed
workflow graph.
...
- [Kanban](/use-routa/kanban) if you want lane-based automation
- [Team](/use-routa/team) if you want lead-driven delegation
